      ...
      <div className="row">
        ...
        <div className="columns">
          <p>
            ...
            consumir a API com isolamento de componentes, uso de estados, TDD e
            bibliotecas como o Date-FNS. Também tive a opurtunidade de criar um
            app ReactNative com todas as skills citadas acima reaproveitando o
            código.
          </p>
        </div>
      </div>
